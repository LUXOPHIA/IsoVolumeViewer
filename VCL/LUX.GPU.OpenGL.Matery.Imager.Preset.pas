...
type //$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$【型】
     ...
     {protected}
       ///// アクセス
       function GetImager :TGLImager2D_TAlphaColorF;
     {public}
       ///// プロパティ
       property Imager :TGLImager2D_TAlphaColorF read GetImager;
       ///// メソッド
       procedure Use;
       procedure Unuse;
     end;
     ...
     private
     protected
       _Imager :TGLImager2D_TAlphaColorF;
       ///// アクセス
       function GetImager :TGLImager2D_TAlphaColorF;
     public
       constructor Create;
...
function TGLMateryImag.GetImager :TGLImager2D_TAlphaColorF;
begin
     Result := _Imager;
end;
...
begin
     ...
     _Imager := TGLImager2D_TAlphaColorF.Create;
end;
...
function TGLMateryImagG.GetImager :TGLImager2D_TAlphaColorF;
begin
     Result := _Imager;
end;
